...
},{"./helpers/util":12}],7:[function(require,module,exports){
"use strict";
...
},{"./locales/en":14}],8:[function(require,module,exports){
"use strict";
...
},{"./ZodError":6,"./errors":7,"./helpers/parseUtil":10,"./helpers/typeAliases":11,"./helpers/util":12,"./types":15}],9:[function(require,module,exports){
"use strict";
...
},{"../errors":7,"../locales/en":14}],11:[function(require,module,exports){
"use strict";
...
},{"./external":8}],14:[function(require,module,exports){
"use strict";
...
},{"../ZodError":6,"../helpers/util":12}],15:[function(require,module,exports){
"use strict";
...
},{"./ZodError":6,"./errors":7,"./helpers/errorUtil":9,"./helpers/parseUtil":10,"./helpers/util":12}],16:[function(require,module,exports){
"use strict";
...
},{"./lib/device-api-call.js":17,"./lib/device-api.js":18}],17:[function(require,module,exports){
"use strict";
...
},{"./lib/apple.password.js":20,"./lib/constants.js":21,"./lib/rules-parser.js":22}],20:[function(require,module,exports){
"use strict";
...
},{"./constants.js":21,"./rules-parser.js":22}],21:[function(require,module,exports){
"use strict";
...
},{"../packages/device-api/index.js":16,"./DeviceInterface/AndroidInterface.js":25,"./DeviceInterface/AppleDeviceInterface.js":26,"./DeviceInterface/AppleOverlayDeviceInterface.js":27,"./DeviceInterface/ExtensionInterface.js":28,"./DeviceInterface/WindowsInterface.js":30,"./DeviceInterface/WindowsOverlayDeviceInterface.js":31,"./Settings.js":54,"./config.js":67,"./deviceApiCalls/transports/transports.js":75}],25:[function(require,module,exports){
"use strict";
...
},{"../UI/controllers/NativeUIController.js":60,"../autofill-utils.js":65,"./InterfacePrototype.js":29,"@duckduckgo/content-scope-scripts/src/apple-utils":1}],26:[function(require,module,exports){
"use strict";
...
},{"../../packages/device-api/index.js":16,"../Form/matching.js":45,"../InContextSignup.js":48,"../UI/HTMLTooltip.js":58,"../UI/controllers/HTMLTooltipUIController.js":59,"../UI/controllers/NativeUIController.js":60,"../UI/controllers/OverlayUIController.js":61,"../autofill-utils.js":65,"../deviceApiCalls/__generated__/deviceApiCalls.js":69,"../deviceApiCalls/additionalDeviceApiCalls.js":71,"./InterfacePrototype.js":29,"@duckduckgo/content-scope-scripts/src/apple-utils":1}],27:[function(require,module,exports){
"use strict";
...
},{"../../packages/device-api/index.js":16,"../UI/controllers/HTMLTooltipUIController.js":59,"../deviceApiCalls/__generated__/deviceApiCalls.js":69,"../deviceApiCalls/__generated__/validators.zod.js":70,"./AppleDeviceInterface.js":26,"./overlayApi.js":33}],28:[function(require,module,exports){
"use strict";
...
},{"../Form/matching.js":45,"../InContextSignup.js":48,"../UI/HTMLTooltip.js":58,"../UI/controllers/HTMLTooltipUIController.js":59,"../autofill-utils.js":65,"./InterfacePrototype.js":29}],29:[function(require,module,exports){
"use strict";
...
},{"../../packages/device-api/index.js":16,"../EmailProtection.js":34,"../Form/formatters.js":38,"../Form/matching.js":45,"../InputTypes/Credentials.js":49,"../PasswordGenerator.js":52,"../Scanner.js":53,"../Settings.js":54,"../UI/controllers/NativeUIController.js":60,"../autofill-utils.js":65,"../config.js":67,"../deviceApiCalls/__generated__/deviceApiCalls.js":69,"../deviceApiCalls/__generated__/validators.zod.js":70,"../deviceApiCalls/transports/transports.js":75,"./initFormSubmissionsApi.js":32}],30:[function(require,module,exports){
"use strict";
...
function initFormSubmissionsApi(forms) {
  ...
  window.addEventListener('pointerdown', event => {
    ...
    if (!matchingForm) {
      const selector = _selectorsCss.SUBMIT_BUTTON_SELECTOR + ', a[href="#"], a[href^=javascript], *[onclick]';
...
},{"../Form/selectors-css.js":46,"../autofill-utils.js":65}],33:[function(require,module,exports){
"use strict";
  ...
  getRawValues() {
    ...
    if (formValues.credentials.password && !formValues.credentials.username && !formValues.identities.emailAddress) {
      ...
      const probableField = hiddenFields.find(field => {
        const regex = (0, _matching.safeRegex)('email|' + this.matching.ddgMatcher('username')?.match);
...
},{"../autofill-utils.js":65,"../constants.js":68,"./FormAnalyzer.js":36,"./formatters.js":38,"./inputStyles.js":39,"./inputTypeConfig.js":40,"./matching.js":45}],36:[function(require,module,exports){
"use strict";
...
class FormAnalyzer {
  ...
  evaluateElement(el) {
    ...
    if (el instanceof HTMLAnchorElement && el.href && el.getAttribute('href') !== '#' || (el.getAttribute('role') || '').toUpperCase() === 'LINK' || el.matches('button[class*=secondary]')) {
      let shouldFlip = true;
      if (resetPasswordLink.test(string) ||
...
},{"../autofill-utils.js":65,"../constants.js":68,"./matching-configuration.js":43,"./matching.js":45}],37:[function(require,module,exports){
"use strict";
...
},{"../InputTypes/Credentials.js":49,"../InputTypes/CreditCard.js":50,"../InputTypes/Identity.js":51,"../UI/img/ddgPasswordIcon.js":63,"../constants.js":68,"./logo-svg.js":42,"./matching.js":45}],41:[function(require,module,exports){
"use strict";
...
`.trim();
const daxBase64 = `data:image/svg+xml;base64,${window.btoa(daxSvg)}`;
  ...
  strategies: {
    ...
    vendorRegex: {
      ...
      // [0] https://github.com/bitwarden/browser/blob/c2b8802201fac5e292d55d5caf3f1f78088d823c/src/services/autofill.service.ts#L436
      {
        ...
        'street-address': '(^address$)' + '|(^street-?address$)' + '|(^addr$)' + '|(^street$)' + '|(^mailing-?addr(ess)?$)' +
      ...
      // [1] https://source.chromium.org/chromium/chromium/src/+/master:components/autofill/core/common/autofill_regex_constants.cc
      {
        ...
        // ==== Telephone ====
        tel: 'phone|mobile|contact.?number' + '|telefonnummer' +
        // de-DE
        '|telefono|teléfono' +
        // es
        '|telfixe' +
        ...
        // ==== Address Fields ====
        organization: 'company|business|organization|organisation' +
        ...
        'address-line1': '^address$|address[_-]?line[_-]?(1|one)|address1|addr1|street' + '|(?:shipping|billing)address$' + '|strasse|straße|hausnummer|housenumber' +
        // de-DE
        '|house.?name' +
        // en-GB
        '|direccion|dirección' +
        ...
        'address-line2': 'address[_-]?line(2|two)|address2|addr2|street|suite|unit(?!e)' +
        // Firefox adds `(?!e)` to unit to skip `United State`
        ...
        'address-line3': 'address[_-]?line(3|three)|address3|addr3|street|suite|unit(?!e)' +
        // Firefox adds `(?!e)` to unit to skip `United State`
        '|adresszusatz|ergänzende.?angaben' +
        // de-DE
        ...
        'address-level2': 'city|town' + '|\\bort\\b|stadt' +
        // de-DE
        '|suburb' +
        // en-AU
        ...
        'county|region|province' + '|county|principality' +
        // en-UK
        '|都道府県' +
        // ja-JP
        '|estado|provincia' +
        ...
        country: 'country|countries' + '|país|pais' +
        // es
        '|(\\b|_)land(\\b|_)(?!.*(mark.*))' +
        // de-DE landmark is a type in india.
        ...
        // ==== Name Fields ====
        'cc-name': 'card.?(?:holder|owner)|name.*(\\b)?on(\\b)?.*card' + '|(?:card|cc).?name|cc.?full.?name' + '|karteninhaber' +
        // de-DE
        '|nombre.*tarjeta' +
        // es
        '|nom.*carte' +
        ...
        name: '^name|full.?name|your.?name|customer.?name|bill.?name|ship.?name' + '|name.*first.*last|firstandlastname' + '|nombre.*y.*apellidos' +
        // es
        '|^nom(?!bre)' +
        // fr-FR
        '|お名前|氏名' +
        ...
        'given-name': 'first.*name|initials|fname|first$|given.*name' + '|vorname' +
        // de-DE
        '|nombre' +
        // es
        ...
        'family-name': 'last.*name|lname|surname|last$|secondname|family.*name' + '|nachname' +
        // de-DE
        '|apellidos?' +
        // es
        '|famille|^nom(?!bre)' +
        ...
        'cc-number': '(add)?(?:card|cc|acct).?(?:number|#|no|num|field)' +
        ...
        'cc-exp': 'expir|exp.*date|^expfield$' + '|gueltig|gültig' +
        // de-DE
        '|fecha' +
        // es
        '|date.*exp' +
...
},{"./selectors-css.js":46}],44:[function(require,module,exports){
"use strict";
...
class Matching {
  ...
  constructor(config) {
    ...
    const {
      rules,
      ruleSets
    } = this.#config.strategies.vendorRegex;
    this.#vendorRegExpCache = (0, _vendorRegex.createCacheableVendorRegexes)(rules, ruleSets);
...
},{"../autofill-utils.js":65,"../constants.js":68,"./label-util.js":41,"./matching-configuration.js":43,"./matching-utils.js":44,"./selectors-css.js":46,"./vendor-regex.js":47}],46:[function(require,module,exports){
"use strict";
...
const username = [`${GENERIC_TEXT_FIELD}[autocomplete^=user i]`, `input[name=username i]`,
// fix for `aa.com`
`input[name="loginId" i]`,
// fix for https://online.mbank.pl/pl/Login
`input[name="userid" i]`, `input[id="userid" i]`, `input[name="user_id" i]`, `input[name="user-id" i]`, `input[id="login-id" i]`, `input[id="login_id" i]`, `input[id="loginid" i]`, `input[name="login" i]`, `input[name=accountname i]`, `input[autocomplete=username i]`, `input[name*=accountid i]`, `input[name="j_username" i]`, `input[id="j_username" i]`,
...
`input[id="w3c_accountsbundle_accountrequeststep1_login" i]`, `input[id="username" i]`, `input[name="_user" i]`, `input[name="login_username" i]`,
...
},{"./autofill-utils.js":65,"./deviceApiCalls/__generated__/deviceApiCalls.js":69}],49:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":65}],50:[function(require,module,exports){
"use strict";
...
},{"../Form/formatters.js":38}],52:[function(require,module,exports){
"use strict";
...
},{"../packages/password/index.js":19,"../packages/password/rules.json":23}],53:[function(require,module,exports){
"use strict";
...
class DefaultScanner {
  ...
  findEligibleInputs(context) {
    ...
    if ('matches' in context && context.matches?.(_selectorsCss.FORM_INPUTS_SELECTOR)) {
  ...
  getParentForm(input) {
    ...
    while (element.parentElement && element.parentElement !== document.documentElement) {
      ...
      const buttons = element.querySelectorAll(_selectorsCss.SUBMIT_BUTTON_SELECTOR);
...
},{"./Form/Form.js":35,"./Form/matching.js":45,"./Form/selectors-css.js":46,"./autofill-utils.js":65,"./constants.js":68,"./deviceApiCalls/__generated__/deviceApiCalls.js":69}],54:[function(require,module,exports){
"use strict";
...
},{"../packages/device-api/index.js":16,"./autofill-utils.js":65,"./deviceApiCalls/__generated__/deviceApiCalls.js":69,"./deviceApiCalls/__generated__/validators.zod.js":70,"@duckduckgo/content-scope-scripts/src/apple-utils":1}],55:[function(require,module,exports){
"use strict";
...
},{"../InputTypes/Credentials.js":49,"../autofill-utils.js":65,"./HTMLTooltip.js":58}],56:[function(require,module,exports){
"use strict";
...
},{"../../Form/inputTypeConfig.js":40,"../../Form/matching.js":45,"../../autofill-utils.js":65,"../DataHTMLTooltip.js":55,"../EmailHTMLTooltip.js":56,"../EmailSignupHTMLTooltip.js":57,"../HTMLTooltip.js":58,"./UIController.js":62}],60:[function(require,module,exports){
"use strict";
...
},{"../../Form/matching.js":45,"../../InputTypes/Credentials.js":49,"../../deviceApiCalls/__generated__/deviceApiCalls.js":69,"./UIController.js":62}],61:[function(require,module,exports){
"use strict";
...
const isLikelyASubmitButton = el => {
  ...
  /submit/i.test(dataTestId) || SUBMIT_BUTTON_REGEX.test(text) ||
...
},{"./Form/matching.js":45}],66:[function(require,module,exports){
"use strict";
...
},{"./DeviceInterface.js":24,"./autofill-utils.js":65,"./requestIdleCallback.js":77}],67:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api":16,"./validators.zod.js":70}],70:[function(require,module,exports){
"use strict";
...
},{"zod":13}],71:[function(require,module,exports){
"use strict";
...
},{"../../packages/device-api/index.js":16,"./__generated__/validators.zod.js":70}],72:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api/index.js":16,"../__generated__/deviceApiCalls.js":69}],73:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api/index.js":16,"../__generated__/deviceApiCalls.js":69,"@duckduckgo/content-scope-utils":2}],74:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api/index.js":16,"../../Settings.js":54,"../../autofill-utils.js":65,"../__generated__/deviceApiCalls.js":69}],75:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api/index.js":16}],77:[function(require,module,exports){
"use strict";
